-- Comprehensive fix for the ambiguous column reference issue
-- This addresses both the RLS policies and the audit trigger conflicts
...
-- 4. Drop ALL existing audit triggers for input_distributions (both general and specific)
