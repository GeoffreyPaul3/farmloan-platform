-- Complete fix: Remove ALL triggers and disable RLS for input_distributions
-- This will help us isolate whether the issue is with any triggers or RLS policies
...
-- 3. Drop the updated_at trigger for input_distributions
